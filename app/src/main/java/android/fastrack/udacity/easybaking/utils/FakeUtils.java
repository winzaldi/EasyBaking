...
public class FakeUtils {
    ...
    private static final String Baking_JSON = "[\n" +
            "  {\n" +
            "    \"id\": 1,\n" +
            "    \"name\": \"Nutella Pie\",\n" +
            "    \"ingredients\": [\n" +
    ...
    //get List Baking from JSON String use Gson
    public static List<Baking> getBaking() {
        Gson gson = new Gson();
        Type listType = new TypeToken<List<Baking>>() {
        }.getType();
        return gson.fromJson(Baking_JSON, listType);
    }
